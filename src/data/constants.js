...
export const experiences = [
  {
    ...
    desc: "Developed solutions for bidirectional issues in 10+ languages across 21+ nations, boosted data collection rates by ~200%, and presented results to 150+ coworkers & C-suite execs in a company-wide meeting.",
    skills: [
      "Docker",
      "Terraform",
      "AWS",
